                        ...
                        <div className="input-flex">
                            ...
                            <div className="input-div">
                                ...
                                <datalist id="timeOption">
                                    ...
                                    <option value="03:00">3:30 AM</option>
                                    <option value="04:00">4:00 AM</option>
                                    <option value="04:00">4:30 AM</option>
                                    <option value="05:00">5:00 AM</option>
                                    <option value="05:00">5:30 AM</option>
                                    <option value="06:00">6:00 AM</option>
                                    <option value="06:00">6:30 AM</option>
                                    ...
                                    <option value="21:00">9:30 PM</option>
                                    <option value="22:00">10:00 PM</option>
                                    <option value="22:00">10:30 PM</option>
                                    <option value="23:00">11:00 PM</option>
                                    <option value="23:00">11:30 PM</option>
                                </datalist>
                            </div>
                        </div>
